        ...
        <div class="bodyAdd">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="form-group mt-4">
                        <label for="no_rekening" class="mb-2">No. Rekening</label>
                        <input type="text" name="no_rekening" class="form-control" placeholder="Masukkan nomor rekening penyelenggara" required>
                    </div>
                    <div class="form-group mt-4">
                        <label for="nama_bank" class="mb-2">Nama Bank</label>
                        <input type="text" name="nama_bank" class="form-control" placeholder="Masukkan nama bank rekening" required>
                    </div>
                    <div class="form-group mt-4">
                        <label for="nama_rekening" class="mb-2">Nama Pemilik Rekening</label>
                        <input type="text" name="nama_rekening" class="form-control" placeholder="Masukkan nama rekening penyelenggara" required>
                    </div>
                    <div class="form-group mt-4">
                        <label for="nominal_pajak" class="mb-2">Nominal Pajak 10% per tiket</label>
                    </div>
